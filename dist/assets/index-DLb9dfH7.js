 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bu=1e3,wu=2,Iu=4*60*60*1e3,Su=.5;function Po(n,e=bu,t=wu){const s=e*Math.pow(t,n),i=Math.round(Su*s*(Math.random()-.5)*2);return Math.min(Iu,s+i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $u{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Vu(t)){const s=t.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(t=>t).join(" ")}}function Vu(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ji="@firebase/app",Oo="0.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rf(n){We(new Ae("platform-logger",e=>new $u(e),"PRIVATE")),We(new Ae("heartbeat",e=>new xf(e),"PRIVATE")),Ie(ji,Oo,n),Ie(ji,Oo,"esm2020"),Ie("fire-js","")}Rf("");var Af="firebase",Nf="12.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function je(n,...e){throw br(n,...e)}function Pe(n,...e){return br(n,...e)}function vr(n,e,t){const s={...Of(),[e]:t};return new Lt("auth","Firebase",s).create(e,{appName:n.name})}function Ct(n){return vr(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Lf(n,e,t){const s=t;if(!(e instanceof s))throw s.name!==e.constructor.name&&je(n,"argument-error"),vr(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function br(n,...e){if(typeof n!="string"){const t=e[0],s=[...e.slice(1)];return s[0]&&(s[0].appName=n.name),n._errorFactory.create(t,...s)}return Cl.create(n,...e)}function N(n,e,...t){if(!n)throw br(e,...t)}function Ke(n){const e="INTERNAL ASSERTION FAILED: "+n;throw as(e),new Error(e)}function et(n,e){n||Ke(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zi(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function Ff(){return Uo()==="http:"||Uo()==="https:"}function Uo(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bf(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Ff()||fr()||"connection"in navigator)?navigator.onLine:!0}function Uf(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vn{constructor(e,t){this.shortDelay=e,this.longDelay=t,et(t>e,"Short delay should be less than long delay!"),this.isMobile=ur()||gl()}get(){return Bf()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vo(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Dl(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Al(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Fl(e))return"Blackberry";if(Bl(e))return"Webos";if(Nl(e))return"Safari";if((e.includes("chrome/")||Ol(e))&&!e.includes("edge/"))return"Chrome";if(Ll(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=n.match(t);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function Al(n=ue()){return/firefox\//i.test(n)}function Nl(n=ue()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Ol(n=ue()){return/crios\//i.test(n)}function Dl(n=ue()){return/iemobile/i.test(n)}function Ll(n=ue()){return/android/i.test(n)}function Fl(n=ue()){return/blackberry/i.test(n)}function Bl(n=ue()){return/webos/i.test(n)}function Er(n=ue()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Zf(n=ue()){var e;return Er(n)&&!!((e=window.navigator)!=null&&e.standalone)}function ep(){return lu()&&document.documentMode===10}function Ul(n=ue()){return Er(n)||Ll(n)||Bl(n)||Fl(n)||/windows phone/i.test(n)||Dl(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wl(n,e=[]){let t;switch(n){case"Browser":t=Vo(ue());break;case"Worker":t=`${Vo(ue())}-${n}`;break;default:t=n}const s=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${sn}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function np(n,e={}){return rn(n,"GET","/v2/passwordPolicy",Ir(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Tr={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function op(n){Tr=n}function ap(n){return Tr.loadJS(n)}function lp(){return Tr.gapiScript}function cp(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qt(n,e){return Vf(n,"POST","/v1/accounts:signInWithIdp",Ir(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kr extends $l{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return qt(e,this._buildIdpRequest())}_linkToIdToken(e,t){return qt(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return qt(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function Fp(n){return _p(n.auth,new kr(n),n.bypassAuthState)}function Bp(n){const{auth:e,user:t}=n;return N(t,e,"internal-error"),yp(t,new kr(n),n.bypassAuthState)}async function Up(n){const{auth:e,user:t}=n;return N(t,e,"internal-error"),gp(t,new kr(n),n.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sm=new Vn(3e4,6e4);function Xo(){const n=Ue().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function im(n){return new Promise((e,t)=>{var i,r,o;function s(){Xo(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Xo(),t(Pe(n,"network-request-failed"))},timeout:sm.get()})}if((r=(i=Ue().gapi)==null?void 0:i.iframes)!=null&&r.Iframe)e(gapi.iframes.getContext());else if((o=Ue().gapi)!=null&&o.load)s();else{const a=cp("iframefcb");return Ue()[a]=()=>{gapi.load?s():t(Pe(n,"network-request-failed"))},ap(`${lp()}?onload=${a}`).catch(l=>t(l))}}).catch(e=>{throw hs=null,e})}let hs=null;function rm(n){return hs=hs||im(n),hs}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fm={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},pm=500,mm=600,gm="_blank",ym="http://localhost";class Qo{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function _m(n,e,t,s=pm,i=mm){const r=Math.max((window.screen.availHeight-i)/2,0).toString(),o=Math.max((window.screen.availWidth-s)/2,0).toString();let a="";const l={...fm,width:s.toString(),height:i.toString(),top:r,left:o},c=ue().toLowerCase();t&&(a=Ol(c)?gm:t),Al(c)&&(e=e||ym,l.scrollbars="yes");const h=Object.entries(l).reduce((u,[p,g])=>`${u}${p}=${g},`,"");if(Zf(c)&&a!=="_self")return vm(e||"",a),new Qo(null);const d=window.open(e||"",a,h);N(d,n,"popup-blocked");try{d.focus()}catch{}return new Qo(d)}function vm(n,e){const t=document.createElement("a");t.href=n,t.target=e;const s=document.createEvent("MouseEvent");s.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nc=1e4,sc=`w:${Pr}`,ic="FIS_v2",Om="https://firebaseinstallations.googleapis.com/v1",Dm=60*60*1e3,Lm="installations",Fm="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dg(n){const e=n,{installationEntry:t,registrationPromise:s}=await Ar(e);return s?s.catch(console.error):Nr(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ug(n,e=!1){const t=n;return await fg(t),(await Nr(t,e)).token}async function fg(n){const{registrationPromise:e}=await Ar(n);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Es="analytics",vg="firebase_id",bg="origin",wg=60*1e3,Ig="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Or="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hg{constructor(e){this.app=e}_delete(){return delete Sn[this.app.options.appId],Promise.resolve()}}let Sn={},ia=[];const ra={};let Ti="dataLayer",Gg="gtag",oa,Ic,aa=!1;function qg(){const n=[];if(fr()&&n.push("This is a browser extension environment."),yl()||n.push("Cookies are not available."),n.length>0){const e=n.map((s,i)=>`(${i+1}) ${s}`).join(" "),t=ve.create("invalid-analytics-context",{errorInfo:e});me.warn(t.message)}}function Kg(n,e,t){qg();const s=n.options.appId;if(!s)throw ve.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)me.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${n.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw ve.create("no-api-key");if(Sn[s]!=null)throw ve.create("already-exists",{id:s});if(!aa){xg(Ti);const{wrappedGtag:r,gtagCore:o}=Rg(Sn,ia,ra,Ti,Gg);Ic=r,oa=o,aa=!0}return Sn[s]=zg(n,ia,ra,e,oa,Ti,t),new Hg(n)}function Yg(n=_r()){n=le(n);const e=Ft(n,Es);return e.isInitialized()?e.getImmediate():Xg(n)}function Xg(n,e={}){const t=Ft(n,Es);if(t.isInitialized()){const i=t.getImmediate();if(dt(e,t.getOptions()))return i;throw ve.create("already-initialized")}return t.initialize({options:e})}async function Qg(){if(fr()||!yl()||!pr())return!1;try{return await mr()}catch{return!1}}function Jg(n,e,t,s){n=le(n),$g(Ic,Sn[n.app.options.appId],e,t,s).catch(i=>me.error(i))}const la="@firebase/analytics",ca="0.10.18";function Zg(){We(new Ae(Es,(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return Kg(s,i,t)},"PUBLIC")),We(new Ae("analytics-internal",n,"PRIVATE")),Ie(la,ca),Ie(la,ca,"esm2020");function n(e){try{const t=e.getProvider(Es).getImmediate();return{logEvent:(s,i,r)=>Jg(t,s,i,r)}}catch(t){throw ve.create("interop-component-reg-failed",{reason:t})}}}Zg();var ha={};const da="@firebase/database",ua="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ci={},xi={};function Br(n){const e=n.toString();return Ci[e]||(Ci[e]=new yy),Ci[e]}function _y(n,e){const t=n.toString();return xi[t]||(xi[t]=e()),xi[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cs extends qc{static getInstance(){return new Cs}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!ur()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return E(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const e of this.listens.values())for(const t of e.values())this.sendListen_(t);for(let e=0;e<this.outstandingPuts_.length;e++)this.outstandingPuts_[e]&&this.sendPut_(e);for(;this.onDisconnectRequestQueue_.length;){const e=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(e.action,e.pathString,e.data,e.onComplete)}for(let e=0;e<this.outstandingGets_.length;e++)this.outstandingGets_[e]&&this.sendGet_(e)}sendConnectStats_(){const e={};let t="js";e["sdk."+t+"."+Sc.replace(/\./g,"-")]=1,ur()?e["framework.cordova"]=1:gl()&&(e["framework.reactnative"]=1),this.reportStats(e)}shouldReconnect_(){const e=Cs.getInstance().currentlyOnline();return Bi(this.interruptReasons_)&&e}}Je.nextPersistentConnectionId_=0;Je.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xy(n,e){return on(n.name,e.name)}function $r(n,e){return on(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ms extends Gc{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(E(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}constructor(e,t,s,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=s,this.appCheckTokenProvider_=i,this.log_=qn("p:rest:"),this.listens_={}}listen(e,t,s,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=Ms.getListenId_(e,s),a={};this.listens_[o]=a;const l=xa(e._queryParams);this.restRequest_(r+".json",l,(c,h)=>{let d=h;if(c===404&&(d=null,c=null),c===null&&this.onDataUpdate_(r,d,!1,s),Mt(this.listens_,o)===a){let u;c?c===401?u="permission_denied":u="rest_error:"+c:u="ok",i(u,null)}})}unlisten(e,t){const s=Ms.getListenId_(e,t);delete this.listens_[s]}get(e){const t=xa(e._queryParams),s=e._path.toString(),i=new $n;return this.restRequest_(s+".json",t,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(s,a,!1,null),i.resolve(a)):i.reject(new Error(a))}),i.promise}refreshAuthToken(e){}restRequest_(e,t={},s){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,r])=>{i&&i.accessToken&&(t.auth=i.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+nn(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(s&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=Rn(a.responseText)}catch{ge("Failed to parse JSON response for "+o+": "+a.responseText)}s(null,l)}else a.status!==401&&a.status!==404&&ge("Got unsuccessful REST response for "+o+" Status: "+a.status),s(a.status);s=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ka=10*1e3,p0=30*1e3,m0=5*60*1e3;class g0{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new f0(e);const s=ka+(p0-ka)*Math.random();Tn(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;ye(e,(i,r)=>{r>0&&Oe(this.statsToReport_,i)&&(t[i]=r,s=!0)}),s&&this.server_.reportStats(t),Tn(this.reportStats_.bind(this),Math.floor(Math.random()*2*m0))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class L0{getCompleteChild(e){return null}getChildAfterChild(e,t,s){return null}}const uh=new L0;class Kr{constructor(e,t,s=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=s}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new ft(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return qr(this.writes_,e,s)}}getChildAfterChild(e,t,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Ot(this.viewCache_),r=O0(this.writes_,i,t,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class H0{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const s=this.query_._queryParams,i=new Vr(s.getIndex()),r=h0(s);this.processor_=F0(r);const o=t.serverCache,a=t.eventCache,l=i.updateFullNode(A.EMPTY_NODE,o.getNode(),null),c=r.updateFullNode(A.EMPTY_NODE,a.getNode(),null),h=new ft(l,o.isFullyInitialized(),i.filtersNodes()),d=new ft(c,a.isFullyInitialized(),r.filtersNodes());this.viewCache_=Ys(d,h),this.eventGenerator_=new y0(this.query_)}get query(){return this.query_}}function G0(n){return n.viewCache_.serverCache.getNode()}function q0(n){return Rs(n.viewCache_)}function K0(n,e){const t=Ot(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!W(e)&&!t.getImmediateChild(F(e)).isEmpty())?t.getChild(e):null}function La(n){return n.eventRegistrations_.length===0}function Y0(n,e){n.eventRegistrations_.push(e)}function Fa(n,e,t){const s=[];if(t){E(e==null,"A cancel should cancel all event registrations.");const i=n.query._path;n.eventRegistrations_.forEach(r=>{const o=r.createCancelEvent(t,i);o&&s.push(o)})}if(e){let i=[];for(let r=0;r<n.eventRegistrations_.length;++r){const o=n.eventRegistrations_[r];if(!o.matches(e))i.push(o);else if(e.hasAnyCallback()){i=i.concat(n.eventRegistrations_.slice(r+1));break}}n.eventRegistrations_=i}else n.eventRegistrations_=[];return s}function Ba(n,e,t,s){e.type===ke.MERGE&&e.source.queryId!==null&&(E(Ot(n.viewCache_),"We should always have a full cache before handling merges"),E(Rs(n.viewCache_),"Missing event cache, even though we have a server cache"));const i=n.viewCache_,r=U0(n.processor_,i,e,t,s);return B0(n.processor_,r.viewCache),E(r.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=r.viewCache,ph(n,r.changes,r.viewCache.eventCache.getNode(),null)}function X0(n,e){const t=n.viewCache_.eventCache,s=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(Q,(r,o)=>{s.push(Jt(r,o))}),t.isFullyInitialized()&&s.push(sh(t.getNode())),ph(n,s,t.getNode(),e)}function ph(n,e,t,s){const i=s?[s]:n.eventRegistrations_;return _0(n.eventGenerator_,e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eo{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new eo(t)}node(){return this.node_}}class to{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=se(this.path_,e);return new to(this.syncTree_,t)}node(){return Js(this.syncTree_,this.path_)}}const p_=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},Wa=function(n,e,t){if(!n||typeof n!="object")return n;if(E(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return m_(n[".sv"],e,t);if(typeof n[".sv"]=="object")return g_(n[".sv"],e);E(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},m_=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:E(!1,"Unexpected server value: "+n)}},g_=function(n,e,t){n.hasOwnProperty("increment")||E(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const s=n.increment;typeof s!="number"&&E(!1,"Unexpected increment value: "+s);const i=e.node();if(E(i!==null&&typeof i<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return s;const o=i.getValue();return typeof o!="number"?s:o+s},y_=function(n,e,t,s){return so(e,new to(t,n),s)},no=function(n,e,t){return so(n,new eo(e),t)};function so(n,e,t){const s=n.getPriority().val(),i=Wa(s,e.getImmediateChild(".priority"),t);let r;if(n.isLeafNode()){const o=n,a=Wa(o.getValue(),e,t);return a!==o.getValue()||i!==o.getPriority().val()?new re(a,te(i)):n}else{const o=n;return r=o,i!==o.getPriority().val()&&(r=r.updatePriority(new re(i))),o.forEachChild(Q,(a,l)=>{const c=so(l,e.getImmediateChild(a),t);c!==l&&(r=r.updateImmediateChild(a,c))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const w_=/[\[\].#$\/\u0000-\u001F\u007F]/,I_=/[\[\].#$\u0000-\u001F\u007F]/,Ri=10*1024*1024,Ch=function(n){return typeof n=="string"&&n.length!==0&&!w_.test(n)},xh=function(n){return typeof n=="string"&&n.length!==0&&!I_.test(n)},S_=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),xh(n)},E_=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!Dr(n)||n&&typeof n=="object"&&Oe(n,".sv")},T_=function(n,e,t,s){ni(gr(n,"value"),e,t)},ni=function(n,e,t){const s=t instanceof H?new $y(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+bt(s));if(typeof e=="function")throw new Error(n+"contains a function "+bt(s)+" with contents = "+e.toString());if(Dr(e))throw new Error(n+"contains "+e.toString()+" "+bt(s));if(typeof e=="string"&&e.length>Ri/3&&Ws(e)>Ri)throw new Error(n+"contains a string greater than "+Ri+" utf8 bytes "+bt(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(ye(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Ch(o)))throw new Error(n+" contains an invalid key ("+o+") "+bt(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);Vy(s,o),ni(n,a,s),zy(s)}),i&&r)throw new Error(n+' contains ".value" child '+bt(s)+" in addition to actual children.")}},oo=function(n,e,t,s){if(!xh(t))throw new Error(gr(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},C_=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),oo(n,e,t)},ao=function(n,e){if(F(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},x_=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Ch(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!S_(t))throw new Error(gr(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sv(n){Ec(sn),We(new Ae("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Lh(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),Ie(da,ua,n),Ie(da,ua,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
